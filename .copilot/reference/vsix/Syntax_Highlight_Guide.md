...
![syntax highlighting scopes](/assets/api/language-extensions/syntax-highlighting/scopes.png)
...
![Selecting the 'new language' template in 'yo code'](/assets/api/language-extensions/syntax-highlighting/yo-new-language.png)
...
![Filling in the 'new language' questions](/assets/api/language-extensions/syntax-highlighting/yo-new-language-questions.png)
...
![A new language extension](/assets/api/language-extensions/syntax-highlighting/generated-new-language-extension.png)
...
![Converting an existing TextMate grammar](/assets/api/language-extensions/syntax-highlighting/yo-convert.png)
...
![A yaml grammar using multiline strings and comments](/assets/api/language-extensions/syntax-highlighting/yaml-grammar.png)
...
![scope inspector](/assets/api/language-extensions/syntax-highlighting/scope-inspector.png)
